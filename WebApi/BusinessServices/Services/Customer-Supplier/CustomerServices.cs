...
namespace BusinessServices
{
    public class CustomerServices : ICustomerServices
    {
        ...
        //
        public List<CustomerEntity> GetcustomerById(int customerId)
        {
            var customerModel = (from x in DB.Customers
                                 where x.Is_Delete == false && x.Cust_Id == customerId
                                 ...
                                 select new CustomerEntity
                                 {
                                     ...
                                     Pincode = x.Pincode,
                                     Customer_Ref_Number = x.Customer_Ref_Number,
                                     Customer_GST_Number = x.Customer_GST_Number,
                                     ...
                                     Customer_User_Id = x.Customer_User_Id,
                                     Password = x.Password,
        ...
        public List<CustomerEntity> searchCustomers(string location)
        {
            var list = (from x in DB.Customers
                        where x.Location_Code == location
                        orderby x.Customer_Name
                        select new CustomerEntity
                        {
                            Customer_Name = x.Customer_Name,
            ...
            if (customerEntity != null)
            {
                ...
                using (var scope = new TransactionScope())
                {
                    ...
                    if (customer != null)
                    {
                        ...
                        customer.Parent_Company_Name = customerEntity.Parent_Company_Name;
                        customer.Sales_Person_Id = customerEntity.Sales_Person_Id;
                        customer.Sales_Person_Name = customerEntity.Sales_Person_Name;
                        customer.Route_Id = CLT.Route_Id;
                        customer.Route_Name = CLT.Route_Alias_Name;
                        customer.Route_Code = CLT.Route_Code;
                        customer.Address1 = customerEntity.Address1;
                        customer.Address2 = customerEntity.Address2;
                        customer.Customer_Ref_Number = customerEntity.Customer_Ref_Number;
                        customer.Customer_GST_Number = customerEntity.Customer_GST_Number;
                   ...
                   //     customer.Parent_Company_Name = customerEntity.Primary_Contact_Name;
                        ...
                        customer.Delivery_Location_Name = CLT.Orgin_Location_Name;
                        customer.Delivery_Location_Code = CLT.Orgin_Location_Code;
                        customer.Delivery_Location_Id = CLT.Orgin_Location_Id;
                        ...
                        customer.Store_Type_Other = customerEntity.Store_Type_Other;
                            //customer.Store_Image_Display_Name = customerEntity.Store_Image_Display_Name;
                            //         customer.Store_Owner_Image_Display_Name = customerEntity.Store_Owner_Image_Display_Name;
                                     //customer.Store_Image_Name = customerEntity.Store_Image_Name;
                                     //customer.Store_Owner_Image_Name = customerEntity.Store_Owner_Image_Name;
                                     //customer.Customer_User_Id = customerEntity.Customer_User_Id;
                                     customer.Password = customerEntity.Password;
                                     customer.Longitude = customerEntity.Longitude;
                                     customer.Latitude = customerEntity.Latitude;
                        //customer.Customer_Code = customerEntity.Customer_Code;
                        //customer.Customer_Name = customerEntity.Customer_Name;
                        //customer.Address1 = customerEntity.Address1;
                        //customer.Address2 = customerEntity.Address2;
