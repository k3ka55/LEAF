...
{
    public interface IPhysicalStock
    {
        bool CreatePHysicalStock(PhysicalEntity physicalEntity);
        List<PhysicalStockEntity> GetPhysicalStock(int? roleId, DateTime? date, string ULocation, string Url);
